...
$$
Then there exists a **modification** of $(X_t)$ denoted $(\widetilde X_t)$ that is **Hölder continuous** with exponent $\gamma$ for every $\gamma<\frac{\alpha}{\beta}$ on every compact subset of $T$.
